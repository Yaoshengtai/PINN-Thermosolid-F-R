...
parser.add_argument('--center_value', type=int , default=1 ,help='中心值') 
...
parser.add_argument('--weight_equ1', type=int , default=5 ,help='方程权重')
parser.add_argument('--weight_equ2', type=int , default=25 ,help='方程权重')  #left
parser.add_argument('--weight_equ3', type=int , default=1 ,help='方程权重')  #bottom
